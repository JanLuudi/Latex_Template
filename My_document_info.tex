...
\title{Erstellung einer Methode zur Kostenkalkulation für sensorbasierte Sortieranlagen in verschiedenen Bereichen des Recyclings}
%\titleotherlanguage{Mein Titel\\
%ist lang}

\author{Jan Niklas Ludwig}
\address{Luise-Riegger-Straße 54}
\city{76137 Karlsruhe}
\email{uoxxa@student.kit.edu}
...
\studyprogram{Optische Sortierung}
...
\reviewerone{Prof. Dr.-Ing. Thomas Längle}
\reviewertwo{Prof. Dr.-Ing. }
%
% %% The advisors are PhDs or Postdocs
\advisorone{M.Sc. Merle Flitter}
% %% The second advisor can be omitted
\advisortwo{M.Sc. Georg Maier}
%
% %% Please enter the start end end time of your thesis (for techreport not needed)
\editingtime{01. Dezember 2020}{01. Main 2021}
